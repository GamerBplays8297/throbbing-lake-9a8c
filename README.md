...
With this template, you can deploy your own chat app to converse with other users in real-time. Going to the [demo website](https://throbbing-lake-9a8c.templates.workers.dev) puts you into a unique chat room based on the ID in the url. Share that ID with others to chat with them! This is powered by [Durable Objects](https://developers.cloudflare.com/durable-objects/) and [PartyKit](https://www.partykit.io/).
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/throbbing-lake-9a8c
```

A live public deployment of this template is available at [https://throbbing-lake-9a8c.templates.workers.dev](https://throbbing-lake-9a8c.templates.workers.dev)
